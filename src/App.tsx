...
import { build, carSport, person } from 'ionicons/icons';
import { Redirect, Route } from 'react-router-dom';
import Tab1 from './pages/Cars';
import Tab3 from './pages/Profile';
import Tab2 from './pages/Repairs';
      ...
      <IonReactRouter>
        {!user ? (
          ...
          <IonTabs>
            ...
            <IonTabBar slot="bottom" className="glass-card">
